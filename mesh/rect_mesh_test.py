...
x_min, x_max = 0.0, 10.  # x-axis limits
y_min, y_max = 0.0, 5.0   # y-axis limits

# Points for the rectangle's corners
p1 = gmsh.model.geo.addPoint(x_min, y_min, 0.0, 1.0)
pm = gmsh.model.geo.addPoint(x_max/2, y_min, 0.0, 0.05)
p2 = gmsh.model.geo.addPoint(x_max, y_min, 0.0, 1.0)
p3 = gmsh.model.geo.addPoint(x_max, y_max, 0.0, 1.0)
p4 = gmsh.model.geo.addPoint(x_min, y_max, 0.0, 1.0)

# Lines for the edges of the rectangle
l1 = gmsh.model.geo.addLine(p1, pm)
lm = gmsh.model.geo.addLine(pm, p2)
l2 = gmsh.model.geo.addLine(p2, p3)
l3 = gmsh.model.geo.addLine(p3, p4)
l4 = gmsh.model.geo.addLine(p4, p1)

# Create the surface using the lines
l5 = gmsh.model.geo.addCurveLoop([l1, lm, l2, l3, l4])
#s1 = gmsh.model.geo.addSurfaceFilling([l5])
#s1 = gmsh.model.geo.addSurfaceLoop([l5])
s1 = gmsh.model.geo.addPlaneSurface([l5])
